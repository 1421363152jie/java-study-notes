...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form id="empFrom" action="${path}/ajax_emp_update" method="post"> 
  			<div style="border:1px solid #cecece;">
  		     <input type="hidden" id="uname" value="<s:property value="emp.username"/>">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      ...
				      <td width="32%">
				      <s:textfield name="emp.username" type="text" size="25" regr="^\w{6,8}$" tip="请输入6到8位用户名"> </s:textfield><span style="display: none;"><img width="20px"  src="${path}/images/ok.png"></span>	
				      </td>
