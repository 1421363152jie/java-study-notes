...
<script type="text/javascript">
	...
	*/
	...
	function deleteDep(depId) {
		Dialog.confirm('警告：您确认要删除该部门吗？',function(){	 	
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="70"><a onclick="addDep()" href="javascript:void(0)"><img
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="#page.list" var="dep">
					 <tr align="center" bgcolor="#FFFFFF">
						...
						<s:property value="#dep.depId"/>
						</td>
						<td>
						<s:property value="#dep.name"/>
						</td>
						<td>
						<s:property value="#dep.tel"/>
						</td>
						<td>
							<img src="${path}/images/icon_3.gif" /> 
							<span style="line-height:12px; text-align:center;"> 
								<a onclick="updateDep(<s:property value="#dep.depId"/>)" href="javascript:void(0)" class="xiu">修改</a>
							</span> 
