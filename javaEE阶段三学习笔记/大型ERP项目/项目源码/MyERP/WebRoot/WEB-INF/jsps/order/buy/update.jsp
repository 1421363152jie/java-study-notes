...
<div class="content-right">
	...
	<div class="content-text">
		<form  id="orderFrom" action="${path}/ajax_orderModel_update" method="post">
			<div class="square-o-top">
			<input type="hidden" name="order.orderId" value="<s:property value="order.orderId"/>">
			<input type="hidden" name="order.orderCreater.empId" value="<s:property value="order.orderCreater.empId"/>">
			<input type="hidden" name="order.checkTime" value="<s:property value="order.checkTime"/>">
			<input type="hidden" name="order.details.surplus" value="<s:property value="order.details.surplus"/>">
			...
			<div class="square-order">
				<table id="order" width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr id="defaultTr" align="center" bgcolor="#FFFFFF">
						<td height="30">
					<s:select cssClass="goodsType" style="width:200px" list="order.supplier.productTypes" listKey="productTypeId" listValue="name" name="#detail.product.productType.productTypeId"></s:select>		
						<input type="hidden" name="productTypeIds" value="<s:property value="#detail.product.productType.productTypeId"/>">
						</td>
						<td>
					<s:select cssClass="goods" style="width:200px" list="#detail.product.productType.products" listKey="productId" listValue="name" name="#detail.product.productId"></s:select>		
						<input type="hidden" name="productIds" value="<s:property value="#detail.product.productId"/>">
						</td>
						...
						<td><input name="detailPries" class="prices order_num" style="width:93px;border:1px solid black;text-align:right;padding:2px" type="text" value="<s:property value="#detail.detailPrice"/>"/> 元</td>
						<td class="total" Total="" align="right">
						<s:property value="#detail.detailNum*#detail.detailPrice"/>
						&nbsp;元</td>
						<td>
					...
					<tr id="finalTr" align="center"
						...
						<td class="all" width="16%" align="right">
