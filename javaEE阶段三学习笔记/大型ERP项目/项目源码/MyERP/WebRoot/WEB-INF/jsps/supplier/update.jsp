...
<div class="content-right">
	...
	<div class="content-text">
		<div class="square-order">
			<form id="supplierFrom" action="${path}/ajax_supplier_update" method="post">
  			<div style="border:1px solid #cecece;">
  			<input name="supplier.supplierId" type="hidden" value="<s:property value="supplier.supplierId"/>">
