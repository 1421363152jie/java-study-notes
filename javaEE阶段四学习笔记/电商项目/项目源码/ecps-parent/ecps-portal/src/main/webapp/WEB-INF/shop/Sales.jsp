...
<div class="box bg_white">
	<ul class="uls x_50x50">
		<c:forEach items="${sList}" var="item" varStatus="ind">
			<li>
				<var class="sfont">${ind.index+1}</var>
				<a href="#"  target="_blank" class="pic"><img src="${request_file_path}${item.item.imgs}" /></a>
				<dl>
					<!-- dt 8个文字+... -->
					<dt><a href="#"  target="_blank">${item.item.itemName}</a></dt>
