			...
			<form method="post" action="" name="" class="infor">
				...
				<div class="box_orange">
					...
					<li><label>规　　格：</label><div class="pre spec">
					   <c:forEach items="${item.skuList}" var="sku" varStatus="stat">
						   <c:choose>
					...
					<li><label>我 要 买：</label><a href="javascript:void(0);" class="inb sub"></a>
						<input readonly type="text" name="" value="1" class="num" size="3" /><a href="javascript:void(0);" class="inb add"></a><em id="sub_add_msg" class="red"></em></li>
					<li class="submit">
