...
<div class="w ofc case">
	...
	<div class="box bg_white pb">
		...
		<dl class="distr">
			...
			<dd class="box_d bg_gray2 ofc">
				<ul class="uls form">
				<li><label >送货时间：</label><input type="radio" name="delivery" value="3" checked="checked" />只工作日送货（双休日，节假日不送）</li>
	...
	<div class="box bg_white">
		...
		<dd>
			...
			<div class="box_d bg_gray2 ofc">
				<table cellspacing="0" summary="" id="adrList" class="tab">
					...
					<tr>
						<td colspan="4">
								<input type="radio" value="${addr.shipAddrId}" name="address" <c:if test="${addr.defaultAddr==1}">checked</c:if> />
								${addr.provText}&nbsp;${addr.cityText}&nbsp;${addr.distText}&nbsp;
								${addr.addr}&nbsp;${addr.zipCode}&nbsp;${addr.phone}&nbsp;${addr.shipName}收
						</td>
					</tr>
					</c:forEach>
				<tr>
		...
		<li><label >地　　址：</label><select name="province">
	...
	<div class="box bg_white pb">
		...
		<dl class="distr">
			...
			<dd class="box_d bg_gray2 ofc" style="display:none">
				<ul class="uls form">
				<li><label >发票类型：</label><input type="radio" value="1" name="payable" checked="checked" />个人&nbsp;&nbsp;<input type="radio" value="2" name="payable" />单位</li>
				<li><label >发票抬头：</label><span class="bg_text"><input type="text" id="invoiceNick" name="company" maxLength="32" vld="{required:true}" class="txt" value="亚信联创科技(中国)有限公司" /></span></li>
