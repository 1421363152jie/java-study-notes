$(function(){
    ...
    $('.filter li a').mousedown(function(){
        ...
        /*alert(Price+"   "+keywork+"  "+paraVals+"   "+brandId);*/
        alert(keywork)
        var  Itempath=path+"/item/listItem.do?skuPrice="+Price+"&brandId="+brandId+"&keyworks="+keywork+"&paraVals="+paraVals;
        $("#itemListIframe").attr("src",Itempath);
    });
