...
<div id="tab_1" class="edit set">
    ...
    <p><label>是否是新品：</label>
    	<input  name="isNew" type="radio" value="1" />是&nbsp;&nbsp;
...
<div id="tab_4" style="display:none">
    ...
    <div id="sp_0" class="sp_0">
        <table cellspacing="0" summary="" class="tab3">
           ...
           <c:forEach items="${sList }" var="feature">
           		<tr>
           			<td>${feature.featureName }:</td>
           			<td>
	           				<c:forEach items="${feature.selectValues}" var="val">
	           					<input type="radio" name="${feature.featureId }specradio1" class="specValue1" value="${val }">${val }&nbsp;
	           				</c:forEach>				  
           			</td>
           		</tr>
           </c:forEach>
