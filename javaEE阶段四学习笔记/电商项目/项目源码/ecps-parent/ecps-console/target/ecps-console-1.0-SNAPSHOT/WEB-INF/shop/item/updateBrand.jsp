...
<script type="text/javascript" src="${path}/ecps/console/res/item/updateBrand.js"></script>
...
<div class="frameR"><div class="content">
	...
	<form id="form111" name="form111" action="${path }/item/updateBrand.do" method="post" enctype="multipart/form-data">
		<input type="hidden" name="lastPath" id="lastPath">
		<input type="hidden" name="brandId" value="${brand.brandId}">
		<div class="edit set">
			<p><label><samp>*</samp>品牌名称：</label><input type="text" id="brandName" name="brandName" value="${brand.brandName}" class="text state" reg2="^[a-zA-Z0-9\u4e00-\u9fa5]{1,20}$" tip="必须是中英文或数字字符，长度1-20"/>
				<span></span>
			</p>
            <p><label class="alg_t"><samp>*</samp>品牌LOGO：</label><img id='imgsImgSrc' src="${request_file_path}${brand.imgs}" height="100" width="100" />
             ...
             <p><label></label><input type='file' size='27' id='imgsFile' name='imgsFile' class="file" onchange='submitUpload()' /><span id="submitImgTip" class="pos">请上传图片宽为120px，高为50px，大小不超过100K。</span>
                <input type='hidden' id='imgs' name='imgs' value='${brand.imgs}' reg2="^.+$" tip="亲！您忘记上传图片了。" /><span class="pos">&nbsp;</span>
			</p> 
			...
			<p><label>排序：</label><input type="text" id="brandSort" reg1="^[1-9][0-9]{0,2}$" value="${brand.brandSort}" tip="排序只能输入1-3位数的正整数" name="brandSort" class="text small"/>
				<span class="pos">&nbsp;</span>
			</p>
