...
<div class="frameR"><div class="content">
    ...
    <h2 class="h2_ch"><span id="tabs" class="l">
        ...
        <a id="label4" href="${path}/item/listItem.do?auditStatus=1&showStatus=1"   title="未上架实体商品" class="nor">未上架</a>
        <a id="label5" href="${path}/item/listItem.do?auditStatus=1&showStatus=0"  title="已上架实体商品" class="nor">已上架</a>
    </span></h2>

	<form id="showFrom" action="${path}/item/showItem.do" method="post">
		<input type="hidden" id="itemId" name="itemId">
		<input type="hidden" id="showStatus1" name="showStatus">
		...
		<c:forEach items="${page.list}" var="item">
			<tr>
				...
				<c:if test="${item.showStatus==1}">
					...
					<a href="javascript:void(0);"  onclick="showItem(${item.itemId},0)">上架</a>
				</c:if>
				<c:if test="${item.showStatus==0}">
						<a href="/ecps-console/shop/item/viewItem.jsp" title="查看">查看</a>
						<a href="javascript:void(0);" onclick="showItem(${item.itemId},1)">下架</a>
