...
<head>
	<title>订单详情_付款单_<fmt:message key="OrderMgmtMenu.title" /></title>
...
<form id="myFrom" action="${path}/order/completeTaskByOutcome.do" method="post">
...
<div class="frameR"><div class="content">
	...
	<form id="myForm" action="${path}/order/orderPay/oper.do"
		...
		<div class="sch page_c">
						<span class="l">订单号：<b class="red"><var>${tb.order.orderNum}</var></b>&nbsp;&nbsp;&nbsp;下单时间：<fmt:formatDate value="${tb.order.orderTime}" pattern="yyyy-MM-dd HH:mm:ss" /></b>&nbsp;&nbsp;&nbsp;
	...
	<a href="javascript:void(0);" ref="#tab_3" title="操作记录" class="nor">操作记录</a>
		...
		<div id="tab_2" style="display: none">
			<table cellspacing="0" summary="" class="tab3">
				...
				<tr><th width="12%">支付金额：</th><td><fmt:formatNumber value="${tb.order.orderSum/100}" pattern="#0.00"/>元</td></tr>
