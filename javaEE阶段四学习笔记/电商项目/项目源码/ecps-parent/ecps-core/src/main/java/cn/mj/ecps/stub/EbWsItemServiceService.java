 ...
 * 2018-07-12T21:25:29.938+08:00
 * Generated source version: 2.4.2
 * 
 */
@WebServiceClient(name = "EbWsItemServiceService", 
                  wsdlLocation = "http://localhost:8089/services/publishItem?wsdl",
                  targetNamespace = "http://service.ws.service.ecps.mj.cn/") 
public class EbWsItemServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.ws.service.ecps.mj.cn/", "EbWsItemServiceService");
    public final static QName EbWsItemServicePort = new QName("http://service.ws.service.ecps.mj.cn/", "EbWsItemServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8089/services/publishItem?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EbWsItemServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8089/services/publishItem?wsdl");
        }
        WSDL_LOCATION = url;
    }
