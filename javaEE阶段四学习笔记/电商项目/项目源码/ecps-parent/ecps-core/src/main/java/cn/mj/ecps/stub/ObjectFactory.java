 ...
 * generated in the cn.mj.ecps.stub package. 
...
public class ObjectFactory {
    ...
    private final static QName _PublishItemResponse_QNAME = new QName("http://service.ws.service.ecps.mj.cn/", "publishItemResponse");
    private final static QName _PublishItem_QNAME = new QName("http://service.ws.service.ecps.mj.cn/", "publishItem");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.mj.ecps.stub
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.service.ecps.mj.cn/", name = "publishItemResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.service.ecps.mj.cn/", name = "publishItem")
